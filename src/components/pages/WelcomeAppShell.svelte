...
<template lang="pug">
  ApplicationShell(bind:elementRoot)
    main
      .inset.bg-dark
        .flexrow.justify-flexrow-vertical.center
          .flex2
            img(src!="/modules/{MODULE_ID}/assets/shop-studio-be7c41ff.webp" alt="Shop Studio" style="border: none; ")
        .flexrow.justify-flexrow-vertical
          .flex3
            p.thanks.center.mr-md {t('Welcome.Thanks')}
        hr
        p {t("Welcome.Introduction")}
        a(href="https://github.com/geoidesic/foundryvtt-shop-studio?tab=readme-ov-file#usage-instructions") {t("Welcome.UsageTitle")}
        p.lighter
          i.fa-solid.fa-bug.mr-sm
          | {t('Welcome.Issues')} <a href="https://github.com/geoidesic/foundryvtt-shop-studio/issues"> {t('Welcome.IssuesLinkText')} </a>
        p 
          i.fa-solid.fa-heart.mr-sm(style="color: #660000;")
          | {t('Welcome.Support')} <a href='https://github.com/sponsors/geoidesic'> {t('Welcome.SponsorLinkText')} </a> or <a href='https://paypal.me/geoidesic'>PayPal</a>
        p
